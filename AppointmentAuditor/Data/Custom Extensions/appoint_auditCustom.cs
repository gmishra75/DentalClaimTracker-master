    ...
    public partial class appointment_audit : DataObject
    {
        ...
        public List<string> UserList
        {
            get
            {
                ...
                DataTable dt = Search("SELECT DISTINCT(USER_CHANGED) FROM appointment_audit ORDER BY user_changed");
        ...
        public string ProviderDisplay
        {
            get
            {
                try
                {
                    return LinkedProvider.RSCID + "(" + LinkedProvider.NAME_FIRST + " " + LinkedProvider.NAME_LAST + ")";
                }
                catch { return ""; }
            }
        }
        ...
        public dentrix_providers LinkedProvider
        {
            get
            {
                try
                {
                    ...
                    if (n_PRPROVID > 0)
                    {
                        providerId = n_PRPROVID;
                        providerDB = n_PRPROVDB;
                    }
                    else
                    {
                        providerId = PRPROVID;
                    ...
                    toReturn.URSCID = providerId;
                    toReturn.RSCDB = providerDB;
