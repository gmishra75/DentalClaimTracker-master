...
namespace C_DentalClaimTracker
{
    public partial class procedure : DataObject
    {
        ...
        public DateTime? pl_date
        {
            get
            {
                if (this["pl_date"] is DateTime)
                    return (DateTime)this["pl_date"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (datetime - pl_date)");
            }
            set
            {
    ...
    public partial class call : DataObject, IComparable
    {
        ...
        public DateTime? created_on
        {
            get
            {
                if (this["created_on"] is DateTime)
                    return (DateTime)this["created_on"];
                else
                    return null;
            }
            set
        ...
        public DateTime? updated_on
        {
            get
            {
                if (this["updated_on"] is DateTime)
                    return (DateTime)this["updated_on"];
                else
                    return null;
            }
            set
        ...
        public DateTime StartTime
        {
            get
            {
                if (this["start_time"] is DateTime)
                    return (DateTime)this["start_time"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (DateTime - start_time)");
            }
            set
            {
    ...
    public partial class choice : DataObject, IComparable
    {
        ...
        public DateTime? created_at
        {
            get
            {
                if (this["created_at"] is DateTime)
    ...
    public partial class claim : DataObject
    {
        ...
        public DateTime? updated_on
        {
            get
            {
                ...
                {
                    DateTime? toReturn;
                    toReturn = (DateTime)this["updated_on"];
                    
                    // TEMPORARY CODE FOR FORMATTING
                    if (toReturn.Value.Year == 1900)
                        return null;
                    else
                        return toReturn;
                }
        ...
        public DateTime? patient_dob
        {
            get
            {
                if (this["patient_dob"] is DateTime)
                    return (DateTime)this["patient_dob"];
                else
                    return null;
            }
            set
        ...
        public DateTime? subscriber_dob
        {
            get
            {
                if (this["subscriber_dob"] is DateTime)
                    return (DateTime)this["subscriber_dob"];
                else
                    return null;
            }
            set
        ...
        public DateTime? resent_date
        {
            get
            {
                if (this["resent_date"] is DateTime)
                {
                        return (DateTime)this["resent_date"];
                }
                else
                    return null;
            }
        ...
        public DateTime? tracer_date
        {
            get
            {
                if (this["tracer_date"] is DateTime)
                {
                        return (DateTime)this["tracer_date"];
                }
                else
                    return null;
            }
        ...
        public DateTime? on_hold_date
        {
            get
            {
                if (this["on_hold_date"] is DateTime)
                {
                        return (DateTime)this["on_hold_date"];
                }
                else
                    return null;
            }
        ...
        public DateTime? sent_date
        {
            get
            {
                if (this["sent_date"] is DateTime)
                {
                        return (DateTime)this["sent_date"];
                }
                else
                    return null;
            }
        ...
        public DateTime? revisit_date
        {
            get
            {
                if (this["revisit_date"] is DateTime)
                {
                    return (DateTime)this["revisit_date"];
                }
                else
                    return null;
            }
        ...
        public DateTime? status_last_date
        {
            get
            {
                if (this["status_last_date"] is DateTime)
                {
                    return (DateTime)this["status_last_date"];
                }
                else
                    return null;
            }
        ...
        /// </summary>
        public bool override_address
        {
            get
            {
                if (CommonFunctions.IsNumeric(this["override_address"].ToString()))
                    return Convert.ToBoolean(Convert.ToInt32(this["override_address"]));
                else
                    return false;
            }
            set
            {
                this["override_address"] = Convert.ToInt32(value);
            }
        }
    ...
    public class claim_change_log : DataObject
    {
        ...
        public DateTime? change_date
        {
            get
            {
                if (this["change_date"] is DateTime)
                    return new DateTime?((DateTime)this["change_date"]);
                else
                    throw new DataObjectException("Property value is empty or invalid. (datetime - change_date)");
            }
            set
            {
    ...
    public partial class claim_batch : DataObject
    {
        ...
        public DateTime batch_date
        {
            get
            {
                if (this["batch_date"] is DateTime)
                    return (DateTime)this["batch_date"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (datetime - batch_date)");
            }
            set
            {
        ...
        /// Valid values: NO INFO, Standard Paper Batch, Apex Batch, Resend Daily Summary
        /// </summary>
    ...
    public partial class bad_payment_claims : DataObject
    {
        ...
        public DateTime last_update
        {
            get
            {
                if (this["last_update"] is DateTime)
                    return (DateTime)this["last_update"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (datetime - last_update)");
            }
            set
            {
    ...
    public class claim_sent_history : DataObject
    {
        ...
        public claim_sent_history()
            : base("claim_id", "claim_sent_history")
        {
            PrimaryKeys.Add("sent_date");
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        /// <summary>
        ...
        public claim_sent_history(int ID)
            : base("claim_id", "claim_sent_history", ID)
        {
            PrimaryKeys.Add("sent_date");
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        ...
        public DateTime sent_date
        {
            get
            {
                if (this["sent_date"] is DateTime)
                    ...
                    throw new DataObjectException("Property value is empty or invalid. (DateTime - sent_date)");
            }
            set
            {
                this["sent_date"] = value;
    ...
    public partial class claim_status_history : DataObject
    {
        ...
        public DateTime? date_of_change
        {
            get
            {
                if (this["date_of_change"] is DateTime)
                    return (DateTime?)this["date_of_change"];
                else
                    return new DateTime?();
            }
            set
        ...
        public DateTime? old_revisit_date
        {
            get
            {
                if (this["old_revisit_date"] is DateTime)
                    return (DateTime?)this["old_revisit_date"];
                else
                    return null;
            }
            set
        ...
        public DateTime? new_revisit_date
        {
            get
            {
                if (this["new_revisit_date"] is DateTime)
                    return (DateTime?)this["new_revisit_date"];
                else
                    return null;
            }
            set
    ...
    public partial class user_action_log : DataObject
    {
        ...
        public DateTime action_taken_time
        {
            get
            {
                if (this["action_taken_time"] is DateTime)
                    return (DateTime)this["action_taken_time"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (datetime - action_taken_time)");
            }
            set
            {
    ...
    public partial class provider_eligibility_restrictions : DataObject
    {
        ...
        public DateTime? start_date
        {
            get
            {
                if (this["start_date"] is DateTime)
        ...
        public DateTime? end_date
        {
            get
            {
                if (this["end_date"] is DateTime)
                    return (DateTime)this["end_date"];
                else
                    return null;
            }
            set
    ...
    public class messages : DataObject
    {
        ...
        public DateTime? message_send_date
        {
            get
            {
                if (this["message_send_date"] is DateTime?)
                    return (DateTime?)this["message_send_date"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (datetime - message_send_date)");
            }
            set
            {
    ...
    public class message_recipients : DataObject
    {
        ...
        /// <summary>
        /// Get/Set for the datetime read_date. Throws DataObjectException if the data is null.
        /// </summary>
        public DateTime? read_date
        {
            get
            {
                if (this["read_date"] is DateTime?)
                    return (DateTime?)this["read_date"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (datetime - read_date)");
            }
            set
            {
