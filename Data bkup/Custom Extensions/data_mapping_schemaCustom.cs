...
namespace C_DentalClaimTracker
{
    partial class data_mapping_schema
    {
        ...
        public string GetConnectionString(bool isODBC)
        {
            ...
            if (data_type == DataMappingConnectionTypes.SQLServer)
            {
                ...
                {
                    // Initiate Connection
                    strConnectionString = "Driver={SQL Native Client};uid=" + user_name +
            ...
            else if (data_type == DataMappingConnectionTypes.MySQL)
            {
                ...
                // Initiate Connection
                /*
                strConnectionString = "Driver={MySQL ODBC 5.1 Driver};Server=" + server_name + ";user=" + user_name;
