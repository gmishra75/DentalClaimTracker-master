...
namespace C_DentalClaimTracker
{
    ...
    public partial class insurance_company_group : DataObject
    {
        ...
        public bool multiple_carriers
        {
            get
            {
                if (this["multiple_carriers"] is bool)
                    return (bool) this["multiple_carriers"];
                else if (CommonFunctions.IsNumeric(this["multiple_carriers"].ToString()))
                    return (Convert.ToBoolean(this["multiple_carriers"]));
                else
                    return false;
            }
    ...
    public partial class user_preferences : DataObject
    {
        ...
        /// <summary>
        /// Get/Set for the int claim_form_height. CUSTOM: Returns 30 if the data is null
        /// </summary>
        public int reports_minimumdays
        {
            get
            {
                if (this["reports_minimumdays"] is int)
                    return (int)this["reports_minimumdays"];
                else
                    return 30;
            }
            set
            {
                this["reports_minimumdays"] = value;
            }
        }
    }
    ...
    {
        /// <summary>
        /// The default constructor for the user_preferences_clinics object, creates a new
        /// instance of this object without loading a default record.
        /// </summary>
        public user_preferences_clinics()
            : base("user_id", "user_preferences_clinics")
        {
            PrimaryKeys.Add("clinic_id");
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        /// <summary>
        /// Constructor for the user_preferences_clinics object, creates a new
        /// instance of this object and loads a record using the passed ID.
        /// </summary>
        public user_preferences_clinics(int ID)
            : base("user_id", "user_preferences_clinics", ID)
        {
            PrimaryKeys.Add("clinic_id");
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        ...
        public int clinic_id
        {
            get
            {
                if (this["clinic_id"] is int)
                    ...
                    throw new DataObjectException("Property value is empty or invalid. (int - clinic_id)");
            }
            set
            {
    ...
    {
        start_screen_categories _linkedCategory;

        /// <summary>
        /// The default constructor for the start_screen_buttons object, creates a new
        /// instance of this object without loading a default record.
        /// </summary>
        public start_screen_buttons()
            : base("id", "start_screen_buttons")
        {
            _linkedCategory = null;
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        /// <summary>
        /// Constructor for the start_screen_buttons object, creates a new
        /// instance of this object and loads a record using the passed ID.
        /// </summary>
        public start_screen_buttons(int ID)
            : base("id", "start_screen_buttons", ID)
        {
            _linkedCategory = null;
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        ...
        public start_screen_categories LinkedCategory
        {
            get
            {
                try
                {
                    if (_linkedCategory == null)
                    {
                        _linkedCategory = new start_screen_categories(category_id);
                    }
                }
                catch { throw new DataObjectException.InvalidRecordException(); }
                
                
                return _linkedCategory;
            }
        }
        ...
        /// <summary>
        /// Get/Set for the int category_id. Throws exception if the data is null.
        /// </summary>
        public int category_id
        {
            get
            {
                if (this["category_id"] is int)
                    return (int)this["category_id"];
                else
                    throw new DataObjectException("Property value is empty or invalid. (int - category_id)");
            }
            set
            {
        ...
        /// <summary>
        /// Get/Set for the int is_admin. Throws exception if the data is null.
        /// </summary>
        public bool is_admin
        {
            get
            {
                if (this["is_admin"] is int)
                    return Convert.ToBoolean((int)this["is_admin"]);
                else
                    throw new DataObjectException("Property value is empty or invalid. (int - is_admin)");
            }
            set
            {
                this["is_admin"] = Convert.ToInt32(value);
            }
        }
    ...
    public partial class start_screen_categories : DataObject
    {
        /// <summary>
        /// The default constructor for the start_screen_categories object, creates a new
        /// instance of this object without loading a default record.
        /// </summary>
        public start_screen_categories()
            : base("id", "start_screen_categories")
        {
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        /// <summary>
        /// Constructor for the start_screen_categories object, creates a new
        /// instance of this object and loads a record using the passed ID.
        /// </summary>
        public start_screen_categories(int ID)
            : base("id", "start_screen_categories", ID)
        {
            this.RecordChanged += new DataObject.RecordChangedEventHandler(thisRecordChanged);
        }
        private void thisRecordChanged(object sender, RecordChangedEventArgs e) { }
